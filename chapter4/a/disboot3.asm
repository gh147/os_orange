00007C00  EB34              jmp short 0x7c36
00007C02  90                nop
00007C03  0002              add [bp+si],al
00007C05  0101              add [bx+di],ax
00007C07  0002              add [bp+si],al
00007C09  E000              loopne 0x7c0b
00007C0B  40                inc ax
00007C0C  0BF0              or si,ax
00007C0E  0900              or [bx+si],ax
00007C10  1200              adc al,[bx+si]
...
00007C1E  2900              sub [bx+si],ax
00007C20  0000              add [bx+si],al
00007C22  004F72            add [bx+0x72],cl
00007C25  61                popa
00007C26  6E                outsb
00007C27  676553            gs a32 push bx
00007C2A  302E3032          xor [0x3230],ch
00007C2E  46                inc si
00007C2F  41                inc cx
00007C30  54                push sp
00007C31  3132              xor [bp+si],si
00007C33  2020              and [bx+si],ah
00007C35  208CC88E          and [si-0x7138],cl
00007C39  D88EC0E8          fmul dword [bp-0x1740]
00007C3D  0200              add al,[bx+si]
00007C3F  EBFE              jmp short 0x7c3f
00007C41  B8547C            mov ax,0x7c54
00007C44  89C5              mov bp,ax
00007C46  B91000            mov cx,0x10
00007C49  B80113            mov ax,0x1301
00007C4C  BB0C00            mov bx,0xc
00007C4F  B200              mov dl,0x0
00007C51  CD10              int 0x10
00007C53  C3                ret
00007C54  48                dec ax
00007C55  656C              gs insb
00007C57  6C                insb
00007C58  6F                outsw
00007C59  2C20              sub al,0x20
00007C5B  4F                dec di
00007C5C  53                push bx
00007C5D  20776F            and [bx+0x6f],dh
00007C60  726C              jc 0x7cce
00007C62  642100            and [fs:bx+si],ax
